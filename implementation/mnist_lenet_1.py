...
def train(output_path):
    ...
    model.add(Conv2D(4, kernel_size=(5, 5), strides=(1, 1), activation='tanh', input_shape=(28,28,1), padding='valid'))
    ...
    model.add(Conv2D(12, kernel_size=(5, 5), strides=(1, 1), activation='tanh', padding='valid'))
