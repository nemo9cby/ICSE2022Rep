...
def prepare_data():
    data_dir = '/root/repro/cifar-100-python'
    image_dim = image_size * image_size * img_channels
    meta = unpickle( data_dir + '/meta')
    print (meta.keys())
    print (meta[b'fine_label_names'])
    print (meta[b'coarse_label_names'])
...
def load_data(file_path, data_dir, label_count):
    global image_size, img_channels
    data, labels = load_data_one(data_dir + '/' + file_path)
    #for f in files[1:]:
